...
class ObjectSerializer
{
    ...
    public static function toQueryValue(
        ...
        # Handle BackedEnum objects in query
        if ($value instanceof \BackedEnum) {
            return ["$paramName" => (string) $value->value];
        }
        ...
        $flattenArray = function ($arr, $name, &$result = []) use (&$flattenArray, $style, $explode) {
            ...
            foreach ($arr as $k => $v) {
                $prop = ('deepObject' === $style) ? "{$name}[$k]" : $k;
     ...
     *
     * @param mixed $value an object which will be part of the header
     *
     ...
     */
    public static function deserialize(mixed $data, string $class): mixed
    {
        if (null === $data) {
            return null;
        }
     ...
     * @param int|false $encoding set false to not encode, PHP_QUERY_RFC3986
     *                            to encode using RFC3986, or PHP_QUERY_RFC1738
     *                            to encode using RFC1738
     */
    public static function buildQuery(array $params, bool|int $encoding = PHP_QUERY_RFC3986): string
    {
        if (!$params) {
            return '';
        }
