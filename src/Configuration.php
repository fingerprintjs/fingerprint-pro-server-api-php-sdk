...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.fpjs.io';
     ...
     * @var string
     */
    protected $userAgent = 'Swagger-Codegen/0.3.0-develop.2/php';
    ...
    {
        $report  = 'PHP SDK (Fingerprintjs\ServerAPI) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 3' . PHP_EOL;
        $report .= '    SDK Package Version: 0.3.0-develop.2' . PHP_EOL;
