...
class Integration implements ModelInterface, ArrayAccess
{
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'Integration';
    ...
    protected static array $swaggerTypes = [
        'name' => 'string',
'version' => 'string',
'subintegration' => '\Fingerprint\ServerAPI\Model\IntegrationSubintegration'    ];
...
'subintegration' => 'subintegration'    ];
    ...
    protected static array $setters = [
        'name' => 'setName',
'version' => 'setVersion',
'subintegration' => 'setSubintegration'    ];
    ...
    protected static array $getters = [
        'name' => 'getName',
'version' => 'getVersion',
'subintegration' => 'getSubintegration'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['subintegration'] = isset($data['subintegration']) ? $data['subintegration'] : null;
    }
     ...
     * Sets name
     *
     * @param ?string $name The name of the specific integration, e.g. \"fingerprint-pro-react\".
     *
     * @return $this
     */
     ...
     * Sets version
     *
     * @param ?string $version The version of the specific integration, e.g. \"3.11.10\".
     *
     * @return $this
     */
    ...
    /**
     * Gets subintegration
     * @return ?\Fingerprint\ServerAPI\Model\IntegrationSubintegration
     */
    public function getSubintegration(): ?\Fingerprint\ServerAPI\Model\IntegrationSubintegration
    {
        return $this->container['subintegration'];
    }

    /**
     * Sets subintegration
     *
     * @param ?\Fingerprint\ServerAPI\Model\IntegrationSubintegration $subintegration subintegration
     *
     * @return $this
     */
    public function setSubintegration(?\Fingerprint\ServerAPI\Model\IntegrationSubintegration $subintegration): self
    {
        $this->container['subintegration'] = $subintegration;
