 ...
 */
class ProductPrivacySettings implements ModelInterface, ArrayAccess
{
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'ProductPrivacySettings';
...
'error' => 'getError'    ];
    ...
    /**
     * Gets data
     * @return ?\Fingerprint\ServerAPI\Model\PrivacySettings
     */
    public function getData(): ?\Fingerprint\ServerAPI\Model\PrivacySettings
    {
     ...
     * @return $this
     */
    public function setData(?\Fingerprint\ServerAPI\Model\PrivacySettings $data): self
    {
