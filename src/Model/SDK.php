 ...
 */
class SDK implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = null;

    public const PLATFORM_JS = 'js';
     ...
     *
     */
    protected static string $openAPIModelName = 'SDK';
    ...
    protected static array $openAPITypes = [
        'platform' => 'string',
        'version' => 'string',
        'integrations' => '\Fingerprint\ServerSdk\Model\Integration[]',
    ];
     ...
     * @return string[]
     */
    public function getPlatformAllowableValues(): array
    {
        return [
            self::PLATFORM_JS,
     ...
     * Sets platform.
     *
     * @param string $platform platform of the SDK used for the identification request
     *
     */
     ...
     * Sets version.
     *
     * @param string $version Version string of the SDK used for the identification request. For example: `\"3.12.1\"`
     *
     */
     ...
     * Sets integrations.
     *
     * @param Integration[] $integrations integrations
     *
     */
