 ...
 */
class VelocityData implements ModelInterface, ArrayAccess
{
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'VelocityData';
     ...
     */
    public function getIntervals(): ?\Fingerprint\ServerAPI\Model\VelocityIntervals
    {
     ...
     * @return $this
     */
    public function setIntervals(?\Fingerprint\ServerAPI\Model\VelocityIntervals $intervals): self
    {
