 ...
 */
class IPInfo implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     *
     */
    protected static string $openAPIModelName = 'IPInfo';
