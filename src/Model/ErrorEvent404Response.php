...
class ErrorEvent404Response implements ModelInterface, ArrayAccess
{
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'ErrorEvent404Response';
     ...
     */
    public function getError(): ?\Fingerprint\ServerAPI\Model\ErrorEvent404ResponseError
    {
     ...
     * @return $this
     */
    public function setError(?\Fingerprint\ServerAPI\Model\ErrorEvent404ResponseError $error): self
    {
