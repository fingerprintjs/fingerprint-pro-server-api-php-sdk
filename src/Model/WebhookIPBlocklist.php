 ...
 */
class WebhookIPBlocklist implements ModelInterface, ArrayAccess
{
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'WebhookIPBlocklist';
...
'details' => 'getDetails'    ];
    ...
    /**
     * Gets details
     * @return ?\Fingerprint\ServerAPI\Model\IPBlocklistDetails
     */
    public function getDetails(): ?\Fingerprint\ServerAPI\Model\IPBlocklistDetails
    {
     ...
     * @return $this
     */
    public function setDetails(?\Fingerprint\ServerAPI\Model\IPBlocklistDetails $details): self
    {
