...
class ProductsResponseIdentification implements ModelInterface, ArrayAccess
{
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'ProductsResponseIdentification';
...
'error' => 'getError'    ];
     ...
     */
    public function getData(): ?\Fingerprint\ServerAPI\Model\ProductsResponseIdentificationData
    {
     ...
     * @return $this
     */
    public function setData(?\Fingerprint\ServerAPI\Model\ProductsResponseIdentificationData $data): self
    {
