...
/**
 * ErrorCommon429ResponseError Class Doc Comment
 *
 * @category Class
 ...
 */
class ErrorCommon429ResponseError implements ModelInterface, ArrayAccess
{
    /**
...
'message' => 'getMessage'    ];
     ...
     * Sets code
     *
     * @param string $code Error code: * `TooManyRequests` - The request is throttled.
     *
     * @return $this
     */
