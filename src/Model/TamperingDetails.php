 ...
 */
class TamperingDetails implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     *
     */
    protected static string $openAPIModelName = 'TamperingDetails';
    ...
    {
        $this->setIfExists('anomaly_score', $data ?? [], null);
        $this->setIfExists('anti_detect_browser', $data ?? [], null);
    }
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['anomaly_score']) && ($this->container['anomaly_score'] > 1)) {
            $invalidProperties[] = "invalid value for 'anomaly_score', must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['anomaly_score']) && ($this->container['anomaly_score'] < 0)) {
            $invalidProperties[] = "invalid value for 'anomaly_score', must be bigger than or equal to 0.";
        }
    ...
    {
        if ($anomaly_score > 1) {
            throw new \InvalidArgumentException('invalid value for $anomaly_score when calling TamperingDetails., must be smaller than or equal to 1.');
        }
        if ($anomaly_score < 0) {
            throw new \InvalidArgumentException('invalid value for $anomaly_score when calling TamperingDetails., must be bigger than or equal to 0.');
        }
