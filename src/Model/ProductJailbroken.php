 ...
 */
class ProductJailbroken implements ModelInterface, ArrayAccess
{
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'ProductJailbroken';
...
'error' => 'getError'    ];
    ...
    /**
     * Gets data
     * @return ?\Fingerprint\ServerAPI\Model\Jailbroken
     */
    public function getData(): ?\Fingerprint\ServerAPI\Model\Jailbroken
    {
     ...
     * @return $this
     */
    public function setData(?\Fingerprint\ServerAPI\Model\Jailbroken $data): self
    {
