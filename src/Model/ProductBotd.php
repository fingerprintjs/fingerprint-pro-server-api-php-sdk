 ...
 */
class ProductBotd implements ModelInterface, ArrayAccess
{
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'ProductBotd';
...
'error' => 'getError'    ];
    ...
    /**
     * Gets data
     * @return ?\Fingerprint\ServerAPI\Model\Botd
     */
    public function getData(): ?\Fingerprint\ServerAPI\Model\Botd
    {
     ...
     * @return $this
     */
    public function setData(?\Fingerprint\ServerAPI\Model\Botd $data): self
    {
