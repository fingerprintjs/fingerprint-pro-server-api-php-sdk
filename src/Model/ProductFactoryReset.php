 ...
 */
class ProductFactoryReset implements ModelInterface, ArrayAccess
{
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'ProductFactoryReset';
...
'error' => 'getError'    ];
    ...
    /**
     * Gets data
     * @return ?\Fingerprint\ServerAPI\Model\FactoryReset
     */
    public function getData(): ?\Fingerprint\ServerAPI\Model\FactoryReset
    {
     ...
     * @return $this
     */
    public function setData(?\Fingerprint\ServerAPI\Model\FactoryReset $data): self
    {
