 ...
 */
class RequestHeaderModifications implements ModelInterface, \ArrayAccess, \JsonSerializable
{
     ...
     *
     */
    protected static string $openAPIModelName = 'RequestHeaderModifications';
    ...
    protected static array $openAPITypes = [
        'remove' => 'string[]',
        'set' => '\Fingerprint\ServerSdk\Model\RuleActionHeaderField[]',
        'append' => '\Fingerprint\ServerSdk\Model\RuleActionHeaderField[]',
    ];
     ...
     * Sets remove.
     *
     * @param string[] $remove the list of headers to remove
     *
     */
     ...
     * Sets set.
     *
     * @param RuleActionHeaderField[] $set the list of headers to set, overwriting any existing headers with the same name
     *
     */
     ...
     * Sets append.
     *
     * @param RuleActionHeaderField[] $append the list of headers to append
     *
     */
    public function setAppend(array $append): self
    {
