...
class SignalResponseFrida implements ModelInterface, ArrayAccess
{
    /**
      ...
      * @var string
      */
    protected static string $swaggerModelName = 'SignalResponseFrida';
...
'error' => 'getError'    ];
     ...
     */
    public function getData(): ?\Fingerprint\ServerAPI\Model\FridaResult
    {
     ...
     * @return $this
     */
    public function setData(?\Fingerprint\ServerAPI\Model\FridaResult $data): self
    {
