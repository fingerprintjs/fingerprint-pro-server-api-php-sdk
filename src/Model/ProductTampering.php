...
'error' => 'getError'    ];
    ...
    /**
     * Gets data
     * @return ?\Fingerprint\ServerAPI\Model\Tampering
     */
    public function getData(): ?\Fingerprint\ServerAPI\Model\Tampering
    {
     ...
     * @return $this
     */
    public function setData(?\Fingerprint\ServerAPI\Model\Tampering $data): self
    {
