 ...
 * @internal
 */
#[CoversClass(IPInfoV6::class)]
class IPInfoV6Test extends TestCase
{
    ...
    {
        $model = new IPInfoV6(self::EXAMPLE);
    ...
    public function testSerialization(): void
    {
        ...
        $deserialized = ObjectSerializer::deserialize(json_decode($json), IPInfoV6::class);
    ...
    public function testGetModelName(): void
    {
        ...
        $this->assertEquals('IPInfoV6', $model->getModelName());
    }
